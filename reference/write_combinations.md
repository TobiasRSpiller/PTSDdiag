...
- score_by:
  ...
  (`"balanced_accuracy"`, `"accuracy"`, or `"sensitivity"`). Stored as
  metadata for reproducibility. If `NULL` (default), omitted from the
  file.
...
#> ✔ Combinations written to /tmp/RtmpDImZVB/file19df4fad4de8.json
