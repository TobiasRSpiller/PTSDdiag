...
#'}
#'
#' The data was simulated as a mixture of approximately 17\% individuals with
#' elevated symptom profiles (PTSD-like) and 83\% with low symptom levels,
#' resulting in approximately 21\% meeting full DSM-5 diagnostic criteria.
#'
#' @seealso \code{\link{simulated_ptsd}} for the clinical veteran sample with
#'   higher prevalence.
#'
